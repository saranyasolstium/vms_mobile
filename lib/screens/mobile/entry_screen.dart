...
class _EntryScreenState extends State<EntryScreen> {
  ...
  // Add controller for manual unit input
  ...
  // Helper method to check if purpose is "Contract"
  bool _isContractPurpose() {
    final p = _purposeText();
    return p.contains('contract') && !p.contains('out of contract');
  }

  // Helper method to check if purpose is "Out of Contract"
  ...
  // Method to determine if contact person field should be visible
  bool _shouldShowContactPersonField({required bool isWalkIn}) {
    ...
    // Special behavior ONLY for this location id:
    // - Default: HIDE
    // - Show ONLY when purpose is "Contract" (not "Out of Contract")
    if (currentLocationId == "64f1d7a46fbcc7432ee4889c") {
      return _isContractPurpose() && !_isOutOfContractPurpose();
    }

    // Other locations keep existing logic
  ...
  // ================== UPDATED: label rule ==================
  // Method to get the label text for contact person field
  String _getContactPersonLabel() {
    ...
    // For the specific location, when visible for "Contract", rename label
    if (currentLocationId == "64f1d7a46fbcc7432ee4889c" &&
        _isContractPurpose()) {
      return "Purpose of Contractor";
    }

    // Default label for other cases/locations
...
// Main validator used by BOTH feed & walk-in
  String? validateFormUnified({required bool isWalkIn}) {
    ...
    // contact person - conditional validation
    ...
    if (shouldShowContact) {
      ...
      // For specific location, apply special validation rules
      if (currentLocationId == "64f1d7a46fbcc7432ee4889c") {
        // For "Contract" purpose, field is required
        if (_isContractPurpose() && contactPerson.text.trim().isEmpty) {
          return "Kindly enter Purpose of Contractor";
        }
        // For other purposes in this location, use existing logic
    ...
    if (currentLocationId != "64f1d7a46fbcc2ee4889c") {
      // NOTE: keep your original check if needed
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(children: [
                  ...
                  // Contact Person field with conditional visibility and label
                  if (_shouldShowContactPersonField(isWalkIn: false))
                    authField(_getContactPersonLabel(), contactPerson, 50,
            ...
            (currentLocationId == "64f1d7a46fbcc7432ee4889c")
                ? Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(
                              icon:
                                  const Icon(Icons.add, color: CColors.brand1),
                              onPressed: () {
                      ...
                      // Horizontal Scroll List for Selected Units
                ...
                : // Your existing single unit field for other locations
                Padding(
                    padding: const EdgeInsets.only(bottom: 16),
                    child: SizedBox(
                      height: 50,
  ...
  Future<void> walkIn(String currentLocationId) async {
    ...
    if (currentLocationId == "64f1d7a46fbcc7432ee4889c") {
      ...
      // Additional validation for contract person in specific location
      if (_isContractPurpose() && contactPerson.text.trim().isEmpty) {
...
//     // For the specific location, apply special rules
//     if (currentLocationId == "64f1d7a46fbcc7432ee4889c") {
//       // Show only for "Contract" purpose, hide for "Out of Contract"
//       if (_isContractPurpose()) {
//         return true;
//       }
//       if (_isOutOfContractPurpose()) {
//         return false;
//       }
//       // For other purposes in this location, use existing logic
//       final requiredSet = _requiredFieldsForPurpose(_purposeRule())
...
//     // For other locations, use existing logic
//     final requiredSet = _requiredFieldsForPurpose(_purposeRule())
//       ..addAll(_baseRequiredForFlow(isWalkIn: isWalkIn));
//     return requiredSet.contains('contact');
//   }
...
//     // For the specific location, change label for "Contract"
//     if (currentLocationId == "64f1d7a46fbcc7432ee4889c" &&
//         _isContractPurpose()) {
//       return "Contract Person*";
//     }

//     // Default label for other cases
//     return "Contact Person";
//   }
...
//         // For "Contract" purpose, field is required
//         if (_isContractPurpose() && contactPerson.text.trim().isEmpty) {
//           return "Kindly enter contract person name";
//         }
//         // For other purposes in this location, use existing logic
//         else if (requiredSet.contains('contact') &&
//             contactPerson.text.trim().isEmpty) {
...
//       // Additional validation for contract person in specific location
//       if (_isContractPurpose() && contactPerson.text.trim().isEmpty) {
//         notif('Failed', "Kindly enter contract person name");
//         return;
//       }
//     } else {
//       final err = validateFormUnified(isWalkIn: true); // mobile required
