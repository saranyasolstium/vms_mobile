                  ...
                  Row(
                    children: [
                      ...
                      Consumer<CommonProvider>(builder: (_, provd, __) {
                        ...
                        // current selected id (from API or user)
                        final currentId = selectedPurpose != null
                            ? selectedPurpose['purpose_id']
                            : null;

                        // check if currentId exists in items
                        ...
                        return Container(
                          ...
                          child: DropdownButtonFormField<int>(
                            ...
                            // ✅ only set value if it's really in the list
          ...
          child: Column(children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 12),
                Consumer<CommonProvider>(builder: (_, provd, __) {
                  final items = provd.purpose; // list from provider

                  // current selected id (might have come from mobile API)
                  final currentId = selectedPurpose != null
                      ? selectedPurpose['purpose_id']
                      : null;

                  // check if it's really in the dropdown list
                  final hasCurrent = currentId != null &&
                      items.any((e) => e['purpose_id'] == currentId);
                  ...
                  return Container(
                    ...
                    child: DropdownButtonFormField<int>(
                      ...
                      // ✅ only set value if the id exists in items
                      value: hasCurrent ? currentId : null,
                      items: items.map<DropdownMenuItem<int>>((item) {
                        return DropdownMenuItem<int>(
                          value: item['purpose_id'] as int,
