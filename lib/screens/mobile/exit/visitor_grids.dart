...
// --- conversions ---
  ...
  String _getCombinedPurpose(Map<String, dynamic> data) {
    final visitReason = data['visit_reason'];
    final other = data['other'];

    String purpose = visitReason?['purpose'] ?? "";

    if (other != null && other.isNotEmpty) {
      return purpose.isNotEmpty ? "$purpose - $other" : other;
    }
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Wrap(children: [
                          ...
                          SizedBox(
                            width: MediaQuery.of(context).size.width / 2 - 20,
                            child: widget.data[widget.index]['visit_reason'] ==
                                    null
                                ? content("purpose", "")
                                : content(
                                    "Purpose",
...
class PrintViewScreen extends StatefulWidget {
  ...
  const PrintViewScreen({super.key, required this.data});
  @override
